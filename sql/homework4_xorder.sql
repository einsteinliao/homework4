...
LOCK TABLES `xorder` WRITE;
/*!40000 ALTER TABLE `xorder` DISABLE KEYS */;
INSERT INTO `xorder` VALUES (1,1,1,1000),(2,1,1,1000);
/*!40000 ALTER TABLE `xorder` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-02-13 15:58:06
